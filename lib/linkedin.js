...
_.extend(exports.Linkedin.prototype, {
    ...
    connections: function (user, callback) {
        ...
        this.__people({user: user,
                       fields: ["first-name", "last-name", "location", "public-profile-url", "picture-url", "email-address"],
                       property: "connections"}, callback);
    },

    me: function (callback) {
        this.__people({user: "~",
                       fields: ["id", "first-name", "last-name", "location", "public-profile-url", "picture-url", "email-address"]},
                      callback);
    }
